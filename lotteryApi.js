...
app.post('/calculateWinningChance', async (req, res) => {
  try {
    ...
    console.log(
      'Matching Numbers Count (Five Out Of Six):',
      matchingNumbersCountFiveOutOfSix
    )
    console.log(
      'Matching Numbers Count (Four Out Of Six):',
      matchingNumbersCountFourOutOfSix
    )
    console.log(
      'Matching Numbers Count (Three Out Of Six):',
      matchingNumbersCountThreeOutOfSix
    )
    console.log(
      'Matching Numbers Count (Two Out Of Six):',
      matchingNumbersCountTwoOutOfSix
    )
    console.log(
      'Matching Numbers Count (One Out Of Six):',
      matchingNumbersCountOneOutOfSix
    )
    ...
    const chances = {
      ...
      fiveOutOfSix: calculateChance(
        matchingNumbersCountFiveOutOfSix,
        totalDrawings,
        5
      ),
      fourOutOfSix: calculateChance(
        matchingNumbersCountFourOutOfSix,
        totalDrawings,
        4
      ),
      threeOutOfSix: calculateChance(
        matchingNumbersCountThreeOutOfSix,
        totalDrawings,
        3
      ),
      twoOutOfSix: calculateChance(
        matchingNumbersCountTwoOutOfSix,
        totalDrawings,
        2
      ),
      oneOutOfSix: calculateChance(
        matchingNumbersCountOneOutOfSix,
        totalDrawings,
        1
      ),
...
function calculateChance(matchingNumbersCount, totalDrawings, requiredMatches) {
  ...
  const nonMatchingCombinations = binomialCoefficient(
    6 - requiredMatches,
    6 - requiredMatches
  )
  const chance =
    (combinations * nonMatchingCombinations) / binomialCoefficient(6, 6)
